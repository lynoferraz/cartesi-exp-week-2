...
library CoreDappAddress {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "core", name: "CoreDappAddress", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x7462636f726500000000000000000000436f7265446170704164647265737300);
