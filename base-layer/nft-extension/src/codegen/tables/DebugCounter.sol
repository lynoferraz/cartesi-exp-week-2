...
library DebugCounter {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "tapeNft", name: "DebugCounter", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x7462746170654e6674000000000000004465627567436f756e74657200000000);
